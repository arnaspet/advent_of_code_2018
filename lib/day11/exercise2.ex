defmodule AdventOfCode.Day11.Exercise2 do
  ...
  def find_max_sum_square(summed_area_table) do
    for x <- 0..300, y <- 0..300, square_size <- 1..300, x + square_size <= 300, y + square_size <= 300 do
  ...
  def get_area_sum(
      ...
      get_safe_map_val(summed_area_table, bottom_right) + get_safe_map_val(summed_area_table, top_left) -
